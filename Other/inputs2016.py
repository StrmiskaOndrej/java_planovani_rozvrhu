...
BIT_URL  = FIT_URL + "/study/bc/stplan-l.php.cs?id=180"
    ...
    for row in table.find_all('tr'):
        ...
        for td in row.find_all('td'):
            ...
            for a in td.find_all('a'):
                ...
                # print(a.get('href'))
                if a.get('href') == "stplan-l.php.cs?id=215":
                    study_programs[prog] = (FIT_URL + '/study/msc/' + "stplan-l.php.cs?id=182")
                elif a.get('href') == "stplan-l.php.cs?id=216":
                    study_programs[prog] = (FIT_URL + '/study/msc/' + "stplan-l.php.cs?id=183")
                elif a.get('href') == "stplan-l.php.cs?id=219":
                    study_programs[prog] = (FIT_URL + '/study/msc/' + "stplan-l.php.cs?id=184")
                elif a.get('href') == "stplan-l.php.cs?id=220":
                    study_programs[prog] = (FIT_URL + '/study/msc/' + "stplan-l.php.cs?id=185")
                elif a.get('href') == "stplan-l.php.cs?id=221":
                    study_programs[prog] = (FIT_URL + '/study/msc/' + "stplan-l.php.cs?id=186")
                elif a.get('href') == "stplan-l.php.cs?id=223":
                    study_programs[prog] = (FIT_URL + '/study/msc/' + "stplan-l.php.cs?id=188")
                elif a.get('href') == "stplan-l.php.cs?id=224":
                    study_programs[prog] = (FIT_URL + '/study/msc/' + "stplan-l.php.cs?id=189")
                elif a.get('href') == "stplan-l.php.cs?id=225":
                    study_programs[prog] = (FIT_URL + '/study/msc/' + "stplan-l.php.cs?id=190")
                elif a.get('href') == "stplan-l.php.cs?id=226":
                    study_programs[prog] = (FIT_URL + '/study/msc/' + "stplan-l.php.cs?id=192")
    ...
    for prog in courses:
        ...
        for course in prog['courses']:
            ...
            if course['zkratka'] not in parsed: # download webpage of each course only once
                ...
                # soup = get_webpage("www.fit.vutbr.cz/study/course-l.php?id=11539")
